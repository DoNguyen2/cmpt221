...
with app.app_context():
    ...
    query_1 = """INSERT INTO "Courses" ("CourseID", "CourseName", "Semester", "Year") VALUES (308112, 'Data Management', 'Fall', 2024), (221201, 'Software Development II', 'Fall', 2024), (306112, 'Data Communications', 'Fall', 2024);"""
    ...
    query_3 = """UPDATE "Courses" SET "Semester" = 'Spring', "Year" = 2025 WHERE "CourseID" = 306112; """
    db.session.execute(text(query_3))
    db.session.commit()

    # # write a query to delete 1 record in the Courses table
    query_4 = """DELETE FROM "Courses" WHERE "CourseName"='Data Management'; """
